...
design_R <- expand.grid(intercept=1,
                        y0=c(0,1),
                        a1=c(-1,1));
cond_E_R <- plogis(as.matrix(design_R) %*% theta_R);
...
design_Y2 <- expand.grid(y0=c(0,1),
                         r=c(0,1),
                         a1=c(-1,1),
                         a2NR=c(-1,1));
cond_E_Y2 <- plogis(beta_Y2["intercept"] + 
                      beta_Y2["y0"] * design_Y2[,"y0"] +
                      beta_Y2["r"] * design_Y2[,"r"] + 
                      beta_Y2["a1"] * design_Y2[,"a1"] +
                      beta_Y2["a2NR"] * (1-design_Y2[,"r"]) * design_Y2[,"a2NR"] +
                      beta_Y2["a1a2NR"] * (1-design_Y2[,"r"]) * design_Y2[,"a1"] * design_Y2[,"a2NR"]);
